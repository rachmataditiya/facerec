#############################################################################
# Makefile for building: facerec.app/Contents/MacOS/facerec
# Generated by qmake (3.1) (Qt 6.9.0)
# Project:  facerec.pro
# Template: app
# Command: /opt/homebrew/opt/qt/bin/qmake -o Makefile facerec.pro
#############################################################################
...
CXXFLAGS      = -pipe -stdlib=libc++ -std=c++11 -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.4.sdk -mmacosx-version-min=14.0 -Wall -Wextra $(DEFINES)
INCPATH       = -I. -I/opt/homebrew/opt/opencv/include/opencv4 -IInspireFace/include -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I. -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/AGL.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.4.sdk/System/Library/Frameworks/AGL.framework/Headers -I/opt/homebrew/share/qt/mkspecs/macx-clang -F/opt/homebrew/lib
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = facerec1.0.0
DISTDIR = /Users/rachmataditiya/Documents/Projects/cpp/facerec/.tmp/facerec1.0.0
LINK          = /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang++
LFLAGS        = -stdlib=libc++ -headerpad_max_install_names $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.4.sdk -mmacosx-version-min=14.0 -Wl,-rpath,@executable_path/../Frameworks -Wl,-rpath,/Users/rachmataditiya/Documents/Projects/cpp/facerec/InspireFace/lib -Wl,-rpath,@executable_path/../Frameworks -Wl,-rpath,/opt/homebrew/lib
LIBS          = $(SUBLIBS) -F/opt/homebrew/lib -L/opt/homebrew/opt/opencv/lib -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_videoio -lopencv_imgcodecs -lopencv_video -L/Users/rachmataditiya/Documents/Projects/cpp/facerec/InspireFace/lib -lInspireFace -framework QtWidgets -framework QtGui -framework AppKit -framework ImageIO -framework Metal -framework QtCore -framework IOKit -framework DiskArbitration -framework UniformTypeIdentifiers -framework AGL -framework OpenGL   
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		facerec.pro mainwindow.h main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = facerec
DESTDIR       = 
TARGET        = facerec.app/Contents/MacOS/facerec

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 15.4
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Applications/Xcode.app/Contents/Developer
EXPORT__QMAKE_STASH_ = /Users/rachmataditiya/Documents/Projects/cpp/facerec/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/rachmataditiya/Documents/Projects/cpp/facerec/facerec.pro
...
facerec.app/Contents/MacOS/facerec:  $(OBJECTS)  
	@test -d facerec.app/Contents/MacOS/ || mkdir -p facerec.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: facerec.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/share/qt/mkspecs/common/macx.conf \
...
facerec.app/Contents/PkgInfo: 
	@test -d facerec.app/Contents || mkdir -p facerec.app/Contents
	@$(DEL_FILE) facerec.app/Contents/PkgInfo
	@echo "APPL????" > facerec.app/Contents/PkgInfo
facerec.app/Contents/Info.plist: 
	@test -d facerec.app/Contents || mkdir -p facerec.app/Contents
	@$(DEL_FILE) facerec.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.facerec,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.facerec,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,facerec,g" -e "s,@LIBRARY@,facerec,g" -e "s,\$${EXECUTABLE_NAME},facerec,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >facerec.app/Contents/Info.plist
facerec.app/Contents/Frameworks/libInspireFace.dylib: InspireFace/lib/libInspireFace.dylib
	@test -d facerec.app/Contents/Frameworks || mkdir -p facerec.app/Contents/Frameworks
	@$(DEL_FILE) facerec.app/Contents/Frameworks/libInspireFace.dylib
	@$(COPY_FILE) InspireFace/lib/libInspireFace.dylib facerec.app/Contents/Frameworks/libInspireFace.dylib
facerec.app/Contents/Resources/streams.json: streams.json
	@test -d facerec.app/Contents/Resources || mkdir -p facerec.app/Contents/Resources
	@$(DEL_FILE) facerec.app/Contents/Resources/streams.json
	@$(COPY_FILE) streams.json facerec.app/Contents/Resources/streams.json

all: Makefile \
		facerec.app/Contents/PkgInfo \
		facerec.app/Contents/Info.plist \
		facerec.app/Contents/Frameworks/libInspireFace.dylib \
		facerec.app/Contents/Resources/streams.json facerec.app/Contents/MacOS/facerec
...
qrc_qmake_qmake_immediate.cpp: qmake_qmake_immediate.qrc \
		...
		streams.json
	/opt/homebrew/share/qt/libexec/rcc -name qmake_qmake_immediate qmake_qmake_immediate.qrc -o qrc_qmake_qmake_immediate.cpp
...
moc_mainwindow.cpp: mainwindow.h \
		...
		InspireFace/include/inspireface.h \
		InspireFace/include/intypedef.h \
		InspireFace/include/herror.h \
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/rachmataditiya/Documents/Projects/cpp/facerec/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/rachmataditiya/Documents/Projects/cpp/facerec -I/opt/homebrew/opt/opencv/include/opencv4 -I/Users/rachmataditiya/Documents/Projects/cpp/facerec/InspireFace/include -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.4.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/17/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.4.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib mainwindow.h -o moc_mainwindow.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/facerec/bin || mkdir -p $(INSTALL_ROOT)/opt/facerec/bin
	$(DEL_FILE) -r $(INSTALL_ROOT)/opt/facerec/bin/facerec.app
	
	$(QINSTALL) facerec.app $(INSTALL_ROOT)/opt/facerec/bin/facerec.app
	-$(STRIP) $(INSTALL_ROOT)/opt/facerec/bin/facerec.app/Contents/MacOS/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/opt/facerec/bin/facerec.app
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/facerec/bin/ 
